...
% loading the source data of steel, 10 trials
arc1=load('steel_vase_702_01_HOLD.mat');
arc2=load('steel_vase_702_02_HOLD.mat');
arc3=load('steel_vase_702_03_HOLD.mat');
arc4=load('steel_vase_702_04_HOLD.mat');
arc5=load('steel_vase_702_05_HOLD.mat');
arc6=load('steel_vase_702_06_HOLD.mat');
arc7=load('steel_vase_702_07_HOLD.mat');
arc8=load('steel_vase_702_08_HOLD.mat');
arc9=load('steel_vase_702_09_HOLD.mat');
arc10=load('steel_vase_702_10_HOLD.mat');

% High Frequency Fluid Vibrations, choose second row by default
arc1V=arc1.F0pac(2,:);
arc2V=arc2.F0pac(2,:);
arc3V=arc3.F0pac(2,:);
arc4V=arc4.F0pac(2,:);
